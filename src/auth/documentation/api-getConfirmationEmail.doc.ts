...
export const ApiGetConfirmationEmail = {
  apiOperation: {
    description:
      "This endpoint get data from a link sent to a e-mail in order to confirm the user registration.",
  },

  okForgotPassword: {
    description: "Get a solicitation for confirm the user registration from a e-mail",
    content: {
      "application/json": {
        examples: {
          ForgotPasswordOk: {
